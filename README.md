...
The objective of this lab is to demonstrate Python project structuring, unit testing using Pytest and Unittest, and continuous integration using GitHub Actions.
...
### Pytest CI Workflow
- Runs Pytest on every push and pull request to the `main` branch
